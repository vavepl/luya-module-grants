...
/**
 * This is the model class for table "grants_article".
 *
 * @property integer $id
 ...
 * @property string $detailUrl Return the link to the detail url of a grants item.
...
class Article extends NgRestModel
{
    ...
    {
        return Url::toRoute(['/grants/default/detail', 'id' => $this->id, 'title' => Inflector::slug($this->title)]);
    }
     ...
     * @return Article
     */
    public static function getAvailablegrants($limit = false)
    {
        $q = self::find()
