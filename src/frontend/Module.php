...
namespace vavepl\grants\frontend;

/**
 * grants Frontend Module.
 *
...
final class Module extends \luya\base\Module
{
    ...
    /**
     * @var array The default order for the article overview in the index action for the grants.
     *
    ...
    /**
     * @var array The default order for the category article list in the category action for the grants.
     *
     * In order to read more about activeDataProvider defaultOrder: http://www.yiiframework.com/doc-2.0/yii-data-sort.html#$defaultOrder-detail
     */
     ...
     */
    public $urlRules = [
        ['pattern' => 'grants/<id:\d+>/<title:[a-zA-Z0-9\-]+>/', 'route' => 'grants/default/detail'],
    ];
}
